...
const Signup = () => {
    ...
    return (
        // <section classNameName="m-12 md:m-10 rounded-2xl flex md:flex-row flex-col flex-1 md:items-center md:justify-center items-center justify-center h-screen bg-gradient-to-b from-blue-800 to-indigo-900 text-white">
        //     <div classNameName="flex flex-col gap-6 md:justify-center md:items-center md:w-full ">
        //         <h1 classNameName="uppercase text-center text-5xl font-bold">Sign up</h1>

        //     </div>
        //     <div classNameName="md:flex flex-col items-center justify-center mx-auto h-screen bg-gray-500 hidden">
